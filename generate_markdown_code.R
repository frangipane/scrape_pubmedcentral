...
##   a webscraping search
##  -md.filename (string): name of file to which the generated markdown code
##   is written
##
## EXAMPLE:
##  generate_markdown_code("testDb.sqlite", "trastuzumab", 
##                          "TGI", "makeHTMLplots.rmd")
##==================================================================
generate_markdown_code = function(database.name, topic, plot_type, md.filename) {
  library("DBI")
  library("RSQLite")
